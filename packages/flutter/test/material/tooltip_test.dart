...
void main() {
  ...
  testWidgets('Tooltip overlay ignores pointer by default when passing simple message', (WidgetTester tester) async {
  ...
  testWidgets("Tooltip overlay with simple message doesn't ignore pointer when passing ignorePointer: false", (WidgetTester tester) async {
    const String tooltipMessage = 'Tooltip message';
  ...
  testWidgets("Tooltip overlay doesn't ignore pointer by default when passing rich message", (WidgetTester tester) async {
  ...
  testWidgets('Tooltip overlay with richMessage ignores pointer when passing ignorePointer: true', (WidgetTester tester) async {
    const InlineSpan richMessage = TextSpan(
      children: <InlineSpan>[
        TextSpan(text: 'Rich ', style: TextStyle(fontWeight: FontWeight.bold)),
        TextSpan(text: 'Tooltip'),
